													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad" style="text-align:center;width:100%;">
																<h1
																	style="margin: 0; color: #000000; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;">
																	<span class="tinyMce-placeholder">
                                                                        📢 Recibiste una nueva consulta
                                                                    </span>
																</h1>
															</td>
														</tr>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0; margin-bottom: 16px;">Recibiste
																		una nueva consulta de:
																		<strong>{{ $name }}</strong>.
																	</p>
																	<p style="margin: 0; margin-bottom: 16px;">Datos de
																		contacto:</p>
																	<p style="margin: 0; margin-bottom: 16px;">✉️
																		Correco electronico: <strong>{{ $email }}</strong>
																	</p>
																	<p style="margin: 0; margin-bottom: 16px;">📱
																		Telefono de contacto:
																		<strong>{{ $phone }}</strong>
																	</p>
																	<p style="margin: 0;">🗨️Su consulta: <br><br>
																		<strong>{{ $body }}</strong>
																	</p>
																</div>
															</td>
